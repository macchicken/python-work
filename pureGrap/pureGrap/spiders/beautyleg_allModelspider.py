...
class beautylegAllModelspider(scrapy.Spider):
	...
	def __init__(self, mcookie=None, *args, **kwargs):
	...
	def start_requests(self):
		yield scrapy.Request(url="http://www.beautyleg.com/model_list.php", headers=self.myheaders, cookies={"PHPSESSID":self.myCookie},callback=self.parse)
